...
public class BackEnd{
    ...
    // ModernCal logic
    public void handleModernOperations(Object source, JTextField textField){
    ...
    public void handleRomanOperations(Object source, JTextField textField){
        if (source instanceof JButton button){
            String buttonText = button.getText();

            if (Character.isUpperCase(buttonText.charAt(0))){
                textField.setText(textField.getText().concat(buttonText));
            }
